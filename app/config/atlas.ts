...
export const PUBLIC_ATLAS_ORIGIN = "https://atlas.vanatome.vixotic.in";

export const ATLAS_CATALOG_URL =
  process.env.NEXT_PUBLIC_VANATOME_ATLAS_CATALOG_URL ??
  (process.env.NODE_ENV === "production"
    ? `${PUBLIC_ATLAS_ORIGIN}/releases/1.1.0/catalog.json`
    : LOCAL_ATLAS_CATALOG_URL);

export const ATLAS_ATTRIBUTION_URL =
  ATLAS_CATALOG_URL === LOCAL_ATLAS_CATALOG_URL
    ? "/ATTRIBUTION.txt"
